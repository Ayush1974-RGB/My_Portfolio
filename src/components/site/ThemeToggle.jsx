...
export default function ThemeToggle({ theme, onToggle }) {
  ...
  return (
    <Motion.button
      ...
      className="relative inline-grid h-10 w-[5.95rem] grid-cols-2 items-center rounded-full border border-border bg-background/78 p-1 text-[0.62rem] font-semibold tracking-[0.12em] text-foreground shadow-[var(--theme-shadow)] backdrop-blur max-[360px]:w-[5.6rem] sm:h-11 sm:w-[8rem] sm:text-xs sm:tracking-[0.18em]"
